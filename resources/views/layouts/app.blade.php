...
<head>
    ...
    <title>@yield('title', 'Pastebin') - {{ config('app.name', 'Pastebin') }}</title>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="flex items-center">
                    <a href="{{ route('pastes.index') }}" class="flex items-center space-x-2">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('pastes.index') }}"
                        class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white transition-colors {{ request()->routeIs('pastes.index') ? 'bg-gray-700 text-white' : '' }}">
                        Home
                    </a>
                    <a href="{{ route('pastes.create') }}"
                        class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white transition-colors {{ request()->routeIs('pastes.create') ? 'bg-gray-700 text-white' : '' }}">
                        New Paste
                    </a>
                </div>
            </div>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col sm:flex-row items-center justify-between space-y-2 sm:space-y-0">
                <p class="text-sm text-gray-500">
                    &copy; {{ date('Y') }} <span class="font-semibold text-gray-700">{{ config('app.name', 'Pastebin') }}</span>. All rights reserved.
                </p>
