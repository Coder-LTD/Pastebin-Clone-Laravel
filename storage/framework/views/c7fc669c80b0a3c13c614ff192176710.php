<?php $__env->startSection('title', $paste->title ?: 'Untitled Paste'); ?>
...
<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div class="flex-1 min-w-0">
            <h1 class="text-2xl font-bold text-gray-900 truncate">
                <?php echo e($paste->title ?: 'Untitled Paste'); ?>
            ...
            <div class="mt-2 flex items-center gap-3 flex-wrap">
                ...
                <span class="text-sm text-gray-400 flex items-center gap-1">
                    ...
                    <?php echo e($paste->created_at->format('M d, Y \a\t h:i A')); ?>
                ...
                <?php if($paste->expires_at): ?>
                    <span class="text-sm text-orange-500 flex items-center gap-1">
                        ...
                        Expires <?php echo e($paste->expires_at->diffForHumans()); ?>
    ...
    <div class="flex items-center gap-2 mb-4 p-3 bg-gray-800 rounded-lg">
        ...
        <a href="<?php echo e(route('pastes.raw', $paste->slug)); ?>"
    ...
    <div class="code-block-wrapper">
        <pre class="!m-0"><code id="paste-content" class="language-<?php echo e($paste->language ?? 'plaintext'); ?> hljs text-sm !p-6"><?php echo e($paste->content); ?></code></pre>
    </div>
    ...
    <div class="mt-8 bg-white rounded-lg border border-gray-200 p-5">
        ...
        <div class="flex gap-2">
            <input
                type="text"
                readonly
                value="<?php echo e(route('pastes.show', $paste->slug)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /app/workplace/8c6e71eb-7966-45a0-92f9-345b219e3a2e/resources/views/pastes/show.blade.php ENDPATH**/ ?>